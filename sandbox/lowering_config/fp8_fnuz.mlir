...
module @e2e {
  func.func @attention(
      %arg0: tensor<4x32x4096x64xf8E4M3FNUZ>,
      %arg1: tensor<4x32x4096x64xf8E4M3FNUZ>,
      %arg2: tensor<4x32x4096x64xf8E4M3FNUZ>)
    ...
    %2 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"]} ins(%arg0, %arg1 : tensor<4x32x4096x64xf8E4M3FNUZ>, tensor<4x32x4096x64xf8E4M3FNUZ>) outs(%1 : tensor<4x32x4096x4096xf32>) attrs =  {lowering_config = #iree_gpu.lowering_config<{mma_kind = #iree_gpu.mma_layout<MFMA_F32_16x16x32_F8E4M3FNUZ>, promote_operands = [0, 1], subgroup_basis = [[1, 1, 2, 1, 1], [0, 1, 2, 3, 4]]}>} {
