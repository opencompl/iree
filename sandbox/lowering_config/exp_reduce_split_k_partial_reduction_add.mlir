// RUN: iree-opt --iree-expreduce-reduction-style=add --iree-transform-dialect-interpreter --split-input-file --verify-diagnostics -canonicalize -cse %s

func.func @exp_reduction_split_k_partial_reduction_add(%S: tensor<64x4096xf32>,
                                                       %M: tensor<64xf32>,
                                                       %out: tensor<64xf32>)
