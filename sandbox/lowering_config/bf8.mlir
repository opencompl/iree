...
module @e2e {
  func.func @attention(
      %arg0: tensor<4x32x4096x64xf8E5M2FNUZ>,
      %arg1: tensor<4x32x4096x64xf8E5M2FNUZ>,
      %arg2: tensor<4x32x4096x64xf8E5M2FNUZ>)
    ...
    %2 = linalg.generic {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "parallel", "parallel", "reduction"]} ins(%arg0, %arg1 : tensor<4x32x4096x64xf8E5M2FNUZ>, tensor<4x32x4096x64xf8E5M2FNUZ>) outs(%1 : tensor<4x32x4096x4096xf32>) attrs =  {lowering_config = #iree_gpu.lowering_config<{mma_kind = #iree_gpu.mma_layout<MFMA_F32_16x16x32_F8E5M2FNUZ>, promote_operands = [0, 1], subgroup_basis = [[1, 1, 2, 1, 1], [0, 1, 2, 3, 4]]}>} {
    ^bb0(%in: f8E5M2FNUZ, %in_0: f8E5M2FNUZ, %out: f32):
      %8 = arith.extf %in : f8E5M2FNUZ to f32
      %9 = arith.extf %in_0 : f8E5M2FNUZ to f32
    ...
    %13:3 = iree_linalg_ext.exp_reduction{indexing_maps = [#map, #map3, #map4, #map4, #map2], iterator_types = [#iree_linalg_ext.iterator_type<parallel>, #iree_linalg_ext.iterator_type<parallel>, #iree_linalg_ext.iterator_type<parallel>, #iree_linalg_ext.iterator_type<parallel>, #iree_linalg_ext.iterator_type<reduction>], exp_reduced_operands = [1, 2]} attributes {lowering_config = #iree_gpu.lowering_config<{mma_kind = #iree_gpu.mma_layout<MFMA_F32_16x16x32_F8E5M2FNUZ, col_major = true>, reduction = [0, 0, 0, 0, 32], subgroup_basis = [[1, 1, 2, 1, 1], [0, 1, 2, 3, 4]], workgroup = [1, 1, 64, 0, 0]}>} ins(%2, %arg2 : tensor<4x32x4096x4096xf32>, tensor<4x32x4096x64xf8E5M2FNUZ>) outs(%5, %7, %12 : tensor<4x32x4096xf32>, tensor<4x32x4096xf32>, tensor<4x32x4096x64xf32>) {
    ^bb0(%arg3: f32, %arg4: f8E5M2FNUZ, %arg5: f32, %arg6: f32, %arg7: f32):
      %cst_2 = arith.constant 5.734400e+04 : f32
      %15 = arith.mulf %arg3, %cst_2 : f32
      %16 = arith.truncf %15 : f32 to f8E5M2FNUZ
      %17 = arith.extf %16 : f8E5M2FNUZ to f32
      %18 = arith.extf %arg4 : f8E5M2FNUZ to f32
