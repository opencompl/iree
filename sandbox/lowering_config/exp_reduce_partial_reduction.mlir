...
func.func @exp_reduction_partial_reduction(%S: tensor<64x4096xf32>,
                                           %M: tensor<64xf32>,
                                           %out: tensor<64xf32>)
...
module attributes { transform.with_named_sequence } {
  transform.named_sequence @__transform_main(%module_op: !transform.any_op {transform.readonly}) {
    ...
    %fill_op:2, %split_op, %combining_op:2, %for_op = transform.structured.tile_reduction_using_for %0 by tile_sizes = [0, 128] : (!transform.any_op) -> (!transform.any_op, !transform.any_op, !transform.any_op, !transform.any_op, !transform.any_op, !transform.any_op)
    transform.yield
  }
}
